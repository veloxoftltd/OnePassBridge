...
export default function Badge(props) {
  return (
    <span className={clsx("heroPrimary", styles.label)}>
      <svg
        className={clsx("heroPrimary", styles.svg_label)}
        aria-hidden="true"
        focusable="false"
        data-prefix="fal"
        data-icon="circles-overlap"
        role="img"
